...
INCLUDEPATH += /usr/local/opencv3.2/include \
               /usr/local/opencv3.2/include/opencv \
                /usr/local/opencv3.2/include/opencv2
LIBS += /usr/local/opencv3.2/lib/libopencv_highgui.so \
       /usr/local/opencv3.2/lib/libopencv_core.so    \
       /usr/local/opencv3.2/lib/libopencv_imgproc.so  \
        /usr/local/opencv3.2/lib/libopencv_shape.so   \
        /usr/local/opencv3.2/lib/libopencv_videoio.so \
        /usr/local/opencv3.2/lib/libopencv_imgcodecs.so
